...
const DatabaseManagement = () => {
  ...
  return (
    <div>
      ...
      sm:max-w-sm md:max-w-md lg:max-w-lg mr-6"
      >
        <div className="ml-3 ">
          <button
            type="button"
            className="inline-flex justify-between items-center 
            w-full px-5 py-2 mt-6 text-sm font-medium
              border-gray-300 bg-[#CAD2FF] rounded-md 
              hover:bg-[#CAD2FF] focus:outline-none"
