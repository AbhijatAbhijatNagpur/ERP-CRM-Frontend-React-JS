...
const Menubar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-ignite-menu shadow-lg overflow-auto">
      {/* Logo Image */}
      ...
      <div className="flex justify-center mt-2">
        <img src="/Sphere.png" alt="Logo" className="w-3/4 h-auto" />
      </div>
      ...
      <div className="mt-4 space-y-8 px-2 ">
        <div>
          <Link
          to="/"
            className="w-full flex justify-between items-center p-1 text-right text-md font-semibold bg-ignite-btn rounded"
        ...
        <div>
  <button
    className="w-full flex justify-between items-center p-1 text-left text-md font-semibold bg-ignite-btn rounded"
  ...
  {openDropdown === 'lead-management' && (
    <div className="p-1 bg-ignite-btn border-gray-400 rounded mt-1">
  ...
  <NavLink
    ...
    className={({ isActive }) =>
      `${isActive ? 'bg-ignite-btn' : 'bg-ignite-btn'} bg-ignite-btn`
    }
  >
