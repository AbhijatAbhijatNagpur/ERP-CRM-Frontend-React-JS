...
const CustomerDatabase = () => {
  ...
  return (
    <div className="py-6 ml-64 h-auto">
      <div className="flex items-center mb-3">
        ...
        <div className="flex space-x-10 ml-40">
          ...
          <div className="flex items-center bg-white px-2 rounded-3xl shadow-xl">
            <div className="w-16 h-16 bg-red-100 rounded-full flex justify-center items-center">
      ...
      <div className="flex justify-between items-center  ">
        <button
          className="bg-white text-black text-[16px] font-bold py-3 px-2 mt-1 rounded-sm shadow-xl"
          onClick={GoToCreate}
        >
          ADD NEW CUSTOMER
          <img
