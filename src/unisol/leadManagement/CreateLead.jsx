...
const CreateLead = () => {
  ...
  const isFormEmpty = () => {
    ...
    if (isEmpty) {
      return alert("All credentials required");
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://erp-crm-backend-nodejs.onrender.com/api/lead/addLead",
        formData
      );
  ...
  return (
    <div className=" mt-4 mb-7 ml-64">
      <div className="max-h-screen flex mx-auto space-x-2  ">
        <p className="text-[12px]  font-poppins">Lead Management</p>
        <img className="h-2  " src="/Path 2.png" alt="path" />
      ...
      <div className="bg-[#fff] mt-3 pb-3 rounded-lg">
        <div
        ...
        <div className="px-4">
          ...
          >
            ...
            <div className=" ml-[500px] flex justify-center space-x-6 mt-8">
              <button
                type="submit"
                ...
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-start justify-center pt-2">
                  <div className="bg-white w-full max-w-md rounded-2xl shadow-lg relative pb-4">
                    <div
                      ...
                      style={{
                        backgroundImage: "url('/blueColorBackground.png')",
                      }}
                    >
                    ...
                    <div className="flex flex-col items-center my-4">
                      ...
                      <p className="text-gray-600 text-center">
                        New Lead has been created & added successfully to
                        Database.
                      </p>
                    </div>
